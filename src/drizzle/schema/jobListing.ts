...
// Why define indexes like this?
// Indexes in databases are used to speed up lookups, filtering, and sorting.
//Drizzle lets you define them in schema for better query performance.
